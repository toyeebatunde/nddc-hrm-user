package co.payrail.attendance_srv.integration.s3.service;
...
public class StorageService {
    ...
    @Value("${aws.s3.kycbucketname}")
    private String bucketName;
    @Value("${aws.s3.vas.folder}")
    private String vasFolderName;
    ...
    public String uploadFile(MultipartFile file) {
        ...
        s3Client.putObject(new PutObjectRequest(bucketName, vasFolderName+fileName, fileObj).withCannedAcl(CannedAccessControlList.PublicRead));
        fileObj.delete();
        URL s3Url = s3Client.getUrl(bucketName, vasFolderName+fileName);
    ...
    public byte[] downloadFile(String fileName) {
        S3Object s3Object = s3Client.getObject(bucketName, vasFolderName+fileName);
    ...
    public String deleteFile(String fileName) {
        s3Client.deleteObject(bucketName, vasFolderName+fileName);
